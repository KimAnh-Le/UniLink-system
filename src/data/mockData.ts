...
export const INITIAL_APPOINTMENTS: Appointment[] = [
  {
    ...
    scheduledTime: '10:00 AM - 10:15 AM',
  ...
  },
  {
    ...
    scheduledTime: '03:00 PM - 03:15 PM',
  ...
  },
  {
    ...
    studentEmail: 'chloe.bennett@campus.edu',
    enquiryCategory: 'Academic',
    appointmentDate: '2026-08-03',
    appointmentCategory: 'Online',
    category: 'Graduation Audit Review',
    type: 'Academic Advising',
    appointmentStatus: 'Scheduled',
    status: 'scheduled',
    assignedStaff: 'Dr. Alan Turing',
    ...
    durationMinutes: 15,
    description: 'Final degree audit check for Fall 2026 graduation eligibility.',
    notes: 'Degree audit verified, awaiting final grades.',
    attachmentFile: 'Grad_Audit_Form.pdf',
    location: 'Online Meeting (MS Teams)',
    meetingUrl: 'https://meet.campus.edu/grad-audit-chloe',
  ...
  },
  {
    ...
    studentEmail: 'david.kim@campus.edu',
    enquiryCategory: 'Financial',
    appointmentDate: '2026-08-03',
    appointmentCategory: 'Offline',
    category: 'Scholarship Consultation',
    type: 'Financial Aid Consultation',
    appointmentStatus: 'Scheduled',
    status: 'scheduled',
    ...
    scheduledDate: '2026-08-03',
    scheduledTime: '04:15 PM - 04:45 PM',
    time: '04:15 PM - 04:45 PM',
    durationMinutes: 30,
    description: 'Merit scholarship renewal application and transcript verification.',
    notes: 'Scholarship renewal form signed.',
    attachmentFile: 'Scholarship_App.pdf',
